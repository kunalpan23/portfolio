                ...
                <div>
                    <motion.div animate={{ y: 0, opacity: 1 }} initial={{ y: 30, opacity: 0 }} transition={{ duration: .9, delay: 2, ease: "easeIn" }} >
                        <p className="wrap__pi--description">
                            I'm currently working at <a href="https://www.media.net/" target="_blank">Media.net</a> in Mumbai, India.<br/> I mostly do the front-end development, and I love to Code and<br/> convert Designs in to functional elements. I like to learn more <br/>and more about programming.
                        </p>
                    </motion.div>
                </div> 
            </div>
